    ...
    <GlobalLayout>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;GetSkills.live&quot;, &quot;We&quot;, &quot;Us&quot; or
            &quot;Our&quot; in this Agreement) refers to GetSkills.live.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            who processes the data on behalf of GetSkills.live. It refers to
            third-party companies or individuals employed by GetSkills.live to
            facilitate the Service, to provide the Service on behalf of
            GetSkills.live, to perform services related to the Service or to
            assist GetSkills.live in analyzing how the Service is used.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            <a href="https://getskills.live">https://getskills.live</a>
          </p>
        </li>
        <li>
          <p>
            <strong>You</strong> means the individual accessing or using the
            Service, or GetSkills.live, or other legal entity on behalf of which
      ...
      <ul>
        ...
        <li>
          ...
          permit GetSkills.live, for example, to count users who have visited
      ...
      <ul>
        ...
        <li>
          ...
          <ul>
            <li>Goolge Analytics</li>
          </ul>
          <p>Administered by: Google</p>
        </li>
      </ul>
      <h2 id="use-of-your-personal-data">Use of Your Personal Data</h2>
      <p>GetSkills.live may use Personal Data for the following purposes:</p>
      <ul>
        <li>
          <p>
      ...
      <p>
        GetSkills.live will retain Your Personal Data only for as long as is
      ...
      <p>
        GetSkills.live will also retain Usage Data for internal analysis
      ...
      <p>
        Under certain circumstances, GetSkills.live may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h3 id="other-legal-requirements">Other legal requirements</h3>
      <p>
        GetSkills.live may disclose Your Personal Data in the good faith belief
        that such action is necessary to:
      </p>
      <ul>
        <li>Comply with a legal obligation</li>
        <li>Protect and defend the rights or property of GetSkills.live</li>
        <li>
