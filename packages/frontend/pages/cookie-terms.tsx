    ...
    <GlobalLayout>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to GetSkills.live.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to GetSkills.live, accessible from{" "}
            <a href="https://www.getskills.live">https://www.getskills.live</a>
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>
          ...
          <a href="https://getskills.live/contact">
            https://getskills.live/contact
          </a>
        </li>
      </ul>
    </GlobalLayout>
